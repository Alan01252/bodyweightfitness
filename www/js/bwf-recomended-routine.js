    ...
    exercises: [
        {
            ...
            description: "With your back flat against the wall, slowly raise and lower your hands." +
                    " Perform 5-10 reps.",
            youtube: "d6V2Exzb324",
            enabled: true,
            type: "reps"
        },
        {
            ...
            description: "Grab a band with two hands and hold it out in front of view, then keeping" +
                    " the arms straight move the band to behind your back. Perform 5-10 reps.",
            youtube: "WyW5jGGxoZk",
            enabled: true,
            type: "reps"
        },
        {
            ...
            description: "Get down on your hands and knees, then relax your head and allow it to droop. " +
                    " Move your back up into the air and stretch. Return to the starting position, " +
                    " and then press your stomach towards the floor and your buttocks towards the ceiling. Perform 5-10 reps.",
            youtube: "K9bK0BwKFjs",
            enabled: true,
            type: "reps"
        },
        {
            ...
            description: "Get down on your hands and knees then alternate between pinching and pushing your shoulders." +
                    " Do not move your back. Perform 5-10 reps.",
            youtube: "akgQbxhrhOc",
            enabled: true,
            type: "reps"
        },
        {
            ...
            description: "Stand legs shoulder width apart. Put your hands together with the palms facing the ceiling, " +
                    "slowly rotate your body around in a circle keeping your hands straight. Perform 5-10 reps.",
            youtube: "yRigKuEou7k",
            enabled: true,
            type: "reps"
        },
        {
            ...
            description: "Stand legs shoulder width apart. Swing one leg as far forward as possible, then back as far as possible. Repeat " +
                    "the exercise but move the legs sideways. Perform 5-10 reps.",
            youtube: "4aoUZEZFJF8",
            enabled: true,
            type: "reps"
        },
        {
            ...
            description: "Follow along to the exercises in the video below.",
            youtube: "HU5UCh_E6Ns",
            enabled: true,
            type: "reps"
        },
        {
            name: "Plank",
            description: "Get down on your elbows and knees and lock your hands together. Straighten your legs and raise your body so you're on the balls of your feet." +
                    " Do not arch your back. Hold this position for 10-60 seconds depending on experience.",
            youtube: "PLu6k-uKOJ0",
            enabled: true,
            maxHold: 60,
            type: "hold"
        ...
        {
            name: "Side plank (do both sides)",
            description: "Lie on your right side held up by your elbow. Let your left foot rest on top of your right and push up so that your body performs a triangle with the floor." +
                    " Hold this position for 10-60 seconds depending on experience.",
            youtube: "xIFWxQgFMiE",
            enabled: true,
            maxHold: 60,
            type: "hold"
        ...
        {
            name: "Reverse plank",
            description: "Sit on the floor with your legs out in front of you. Place your palms on the floor and press down lifting your hips and torso towards the ceiling." +
                    " Hold this for 10-60 seconds depending on experience.",
            youtube: "1s1bPYBPERU",
            enabled: true,
            maxHold: 60,
            type: "hold"
        ...
        },
        {
            ...
            levels: [
                ...
                },
                {
                    level: 3,
                    name: "Pull Over",
                    description: "From a dead hand with straight arms pull yourself up and around the bar until you're on top of it. Once on top roll forward and lower the legs performing a negative" +
            ...
            levels: [
                {
                    ...
                    description: "Stand in front of a horizontal bar, keeping your legs shoulder-width apart. Squat down supporting yourself with your hands. Think about sitting backwards, not down. " +
                            "Your knees should not move forwards. Aim for 3 sets of 5-8 reps.",
                    youtube: "OuR_Fp7AB0c",
                    type: "reps",
                    enabled: true
                },
                ...
                },
                {
                    level: 2,
                    name: "Deep Step-up",
                    description: "Putting one leg up on a high object, put all your weight on your front leg and step up to the object. Try not to push off with your back foot. To increase difficulty find" +
                            "a higher object to stand on. Aim for 3 sets of 5-8 reps.",
                    youtube: "487aR3A7HvM",
                    type: "reps",
                    enabled: true
                }
